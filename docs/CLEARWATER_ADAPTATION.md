...
- Room window uses its own 640×256 refraction target and camera, updated with the existing 8 Hz window render. Shared ocean uniforms are restored after each pass.
