export function underwaterMaterials(time){
 return material=>{
  ...
  if(material.name==='Warm lagoon sand'){
  ...
  material.onBeforeCompile=shader=>{
   ...
   `);
   shader.fragmentShader='varying vec3 vSeaPosition;\nuniform float uSeaTime;\n'+shader.fragmentShader;
  ...
  material.customProgramCacheKey=()=> 'underwater-depth-v4-'+material.name;material.needsUpdate=true;
 };
}
